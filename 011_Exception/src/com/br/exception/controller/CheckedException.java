...
public class CheckedException {
	 ...
	 * 	 보통, 외부 매개체(파일, db, 또다른프로그램)와 입출력 할때 발생
	 * 
	 */
	public void method() throws IOException{
		// Scanner와 같이 키보드로 값을 입력받을 수 있는 객체(단, 문자열로만 읽어들일 수 
		...
		/*try {
			...
			System.out.println(str + "글자수는" + str.length() + "입니다");
		}catch(IOException e) {
			System.out.println("예외가 발생했습니다.");
		}
		*/
		
		// 2. throws : 발생된 예외에 대해서 여기서 처리하지 않고 떠넘기겠다(위임한다)
