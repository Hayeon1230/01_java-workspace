...
//import java.lang.Math; //안해도됨 String도
public class B_While {
	...
	public void method1() {
		...
		int i = 1; //for문은 i를 반복문 안에서만, 이건 메소드 안에서
		while(i<=5) {
	...
	public void method3() {
		...
		*/
		...
		// i는 1~10까지 1씩 증가하지만 홀수만 출력되도록
		int i = 1;
		while(i<=10) {
			if(i % 2 == 1) {
			System.out.print(i + " ");//증감 안에 쓰면, 홀수일 때만 증가됨
			}
			i++;
		}
	}
	...
	public void method6() {
		...
		while(true) {
			...
			//동등비교 -> switch(if는 길어지니까)
			switch(menu) {// 기능단위로 정의해놓고 갖다씀
			case 1: method1(); break; // 뒤에 실행되면 안되니까 break
			case 2: method2(); break;
			case 3: method3(); break;
			case 4: method4(); break;
			case 5: method5(); break; 
			case 0: System.out.println("이용해주셔서 감사합니다. 프로그램을 종료합니다."); return;// break는 switch만 나가짐(메뉴판 또나옴)->어쩔 수 없이 메소드나가게 return
			default: System.out.println("메뉴번호를 잘못 입력하셨습니다. 다시 입력해주세요.");
			}
		}
	}
	/*
	...
	public void method9() {
		...
		String str = "";
		do {
			System.out.print("문자열 입력(종료하고자 한다면 exit) : ");
			str = sc.nextLine();
