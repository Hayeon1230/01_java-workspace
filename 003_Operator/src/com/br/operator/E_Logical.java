...
public class E_Logical {
	 ...
	 *   논리연산한 결과값 마저도 논리값임!!
	 * 
	 *   논리값 && 논리값 : 왼쪽, 오른쪽 둘 다 true여야만 최종 결과가 true임
	 *   논리값 || 논리값 : 왼쪽, 오른쪽 둘 중 하나만 true여도 최종 결과는 true임
	 *   
	 */
	...
	public void method1() {
		...
		System.out.print("정수 : ");
		int num = sc.nextInt();
		System.out.println("1~100 사이입니까 : " + ( (1 <= num) && (100 >= num) ));
	...
	public void method2() {
		...
		//'A' ~'Z'	컴퓨터에서는 65~90가지의 숫자로 연달아 나열되어있음
	...
	public void method3() {
		...
		// || : ~이거나, 또는
		// 두 개의 조건 중 하나라도 true라면 최종 결과 값은 true
		// 두 조건 모두 falsr일 경우 최종 결과값은 false
	...
	/*
	 * && : 두 개의 조건이 모두 true여야 결과값이 true (AND == ~이고, ~이면서, 뿐만아니라)
	 * 
	 * true && true	 => true
	 * true && false => false
	 * false && true => false
	...
	public void method6() {
	      ...
	      System.out.println("b % a == 1 : " + (b % a == 1)); // b % a == 1 : true
	      System.out.println("a == 3 && b == 4 : " + (a == 3 && b == 4)); // a == 3 && b == 4 : true
	      System.out.println("!d || a - b > 0 : " + (!d || a - b > 0)); // !d || a - b > 0 : false
