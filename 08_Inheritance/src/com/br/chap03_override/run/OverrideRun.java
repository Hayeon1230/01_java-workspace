...
public class OverrideRun {
	...
	public static void main(String[] args) {
		 ...
		 */
		System.out.println("bk1과 bk3가 같은책입니까(==) : " + (bk1 == bk3)); // false (주소값 비교)
		
		// 레퍼런스간에 비교할때는 equals메소드로 비교 
		System.out.println("bk1과 bk3가 같은책입니까(equals) : " + bk1.equals(bk3));
		
		// 오버라이딩 전 => Object클래스의 equals() : 두 주소값을 비교해서 반환 
		// 오버라이딩 후 => Book클래스의 equals() : 필드값들을 다 비교해서 다 일치하면 true반환 / 그게 아니면 false반환
		
		// 동일 객체로 판별되려면 : equals()메소드 수행시 true여야만 하고 뿐만아니라 hashCode()값이 일치해야만 
		System.out.println("bk1의 해쉬코드값 : " + bk1.hashCode()); // "수학의 정석나수학200".hashCode()
		System.out.println("bk3의 해쉬코드값 : " + bk3.hashCode()); // "수학의 정석나수학200".hashCode()
		
		// Object클래스의 hashCode() : 주소값 가지고 10진수 값 만들어 반환
		// Book클래스의 hashCode() : 실제 필드값 가지고 숫자 만들어 반환 
		System.out.println("bk2의 해쉬코드값 : " + bk2.hashCode()); // "칭찬은 고래도 춤추게 한다고래100".hashCode()
	}
